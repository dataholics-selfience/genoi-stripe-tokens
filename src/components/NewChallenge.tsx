...
const NewChallenge = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = `Eu sou ${firstName}, um profissional gestor antenado nas novidades e que curte uma fala informal e ao mesmo tempo séria nos assuntos relativos ao Desafio. Eu trabalho na empresa ${userData.company || ''} que atua na área de ${formData.businessArea}. O meu desafio é ${formData.title} e a descrição do desafio é ${formData.description}. Faça uma breve saudação bem humorada e criativa que remete à cultura Geek e que tenha ligação direta com o desafio proposto. Depois, fale  em tom formal e direto sobre o desafio descrito, fazendo  uma pergunta técnica complexa - pesquise na internet e seja inteligente ao formular a pergunta bem embasada em aspectos técnicos do desafio descrito e da empresa e sua área de atuação. Uma pergunta inusitada e útil o suficiente para reforçar a descrição do desafio por mim, sem propor nenhuma solução mas tentando entender melhor as causas, consequências, pedaas.`;
